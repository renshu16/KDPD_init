            ...
            function addFile(file) {
                var $li = $('<li id="' + file.id + '">' +
                    ...
                    $btns = $('<div class="file-panel">' +
                        ...
                        '<span class="moveLeft">' + lang.uploadTurnLeft + '</span>' +
                        '<span class="moveRight">' + lang.uploadTurnLeft + '</span>' +
                        '</div>').appendTo($li),
                ...
                $btns.on('click', 'span', function () {
                    ...
                    switch (index) {
                        ...
                        case 2:
                            ...
                            break;
                        case 4: //向后移动
                            console.log($li.next().size());
                            console.log($li.next());
                            if ($li.next().size() > 0 && $li.next().attr("id") != 'filePickerBlock') {
                                $li.next().after($li[0]);
                            }
                            break;
                        case 3: //向前移动
